    ...
    <div className="min-h-[90vh] flex items-center justify-center p-6 bg-[#FAF9F6]">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-black tracking-tighter text-secondary mb-2">Hesap Oluştur</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-primary text-white py-5 rounded-2xl font-black text-lg shadow-xl shadow-primary/20 active:scale-95 transition-all flex items-center justify-center gap-2 mt-4"
          >
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground font-medium">
            Zaten hesabınız var mı? <Link to="/login" className="text-primary font-black">Giriş Yap</Link>
          </p>
        </div>
      </motion.div>
    </div>
